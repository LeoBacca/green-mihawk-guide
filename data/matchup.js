...
},
{
  ...
  tier:'even', sintesi:'Il matchup più discusso di tutto l\'hub dopo il mirror: sette fonti diverse lo trattano e non dicono la stessa cosa. Favorevole ma scomodo — Enel pressa in modo efficiente, e il piano cambia radicalmente a seconda che tu giochi o no il «rest spell».',
  verdetti:[
    {f:'impact', v:'fav', txt:'<b>Go 1st</b> (slide 33 «VS Enel — Go 1st» della guida Law+Yasopp). Il piano per intero, verbatim:<br>• «Establish searchers to remove their 1 cost units without having to invest much in doing so.»<br>• «Use your leader to try and pressure a life every turn ideally. Don\'t really expect your board to stick / not be frozen. If something sticks, use it to swing 7000.»<br>• «Oden is great at stalling out big Enels, Save them to try and do so. Yasopp is great at removing their 4 cost units to prevent them from snowballing into you with stuff sticking into another 4c + removal turn.»<br>• «Make sure to avoid taking too much damage from Enel. Try to counter at least 1 of their swings per turn so that you don\'t lose more than 1 life a turn. You\'ll need a life buffer to resolve back to back Shanks as Enel is one of the decks that can pressure you efficiently.»<br>• «Getting Enel to 0 is basically game over as Shanks send 5 17 is basically always game since they have no +3-4k Event counters.»'},
    {f:'impact', v:'fav', txt:'<b>Video-lezione (01:15–01:19)</b> — la stessa slide raccontata a voce, con due aggiunte che nel PPTX non ci sono.<br>• Il cambio d\'epoca: «You always kind of had to play like a pseudo race against [Enel] — they had removal and you didn\'t — whereas now you have removal too. <b>Before you had to kill them with Dead Man\'s Game, but now you just have Shanks.</b>»<br>• <b>La «secret win condition»</b>: «If your opponent is at one life and you have two Shanks, you just Shanks and you send everything life and then the next turn you Shanks and you kill them.»<br>• Shanks + Luna: «even if you can\'t Luna the Reiju, what you can do is use Shanks kill to Reiju and then Luna the rest of the team»; con abbastanza searcher «you can literally leave them with no attacks going into you the next turn, unless they have a Shura».<br>• Hand-rip Law: «try and play around hand rip Law if you can. If you can\'t, then just deal with it… <b>Vander Decken is a [junk] card in the matchup</b>, so just pitch it for counter, which means that you don\'t need to hold on to Kawamatsu as well.» Obiettivo: «not let them infinity hand rip you a bunch of times back to back turns, because your pieces are more critical than their pieces».'},
    {f:'raph', v:'fav', txt:'Tier list: <b>Slightly Favored</b>. Turn order: Enel è una delle <b>due sole eccezioni in cui si va primi</b> («The decks you want to go first against are Purple Enel and Purple Kaido»). Tech cheatsheet vs Purple Enel: <b>6C Mihawk + 5C Perona</b>.<br>Perché 6C Mihawk qui: «His 7k statline requires Enel to reduce his power before he can be KO\'d by 2C Gum Gum Lightning»; «a 7k attack without attaching DON!! is also difficult for Enel to counter without using their combo pieces as counters»; «since he plays the other character active, they can\'t use 0C Lightning Dragon on it without setting it up»; e «they can also easily wipe out your weenies before the 6 or 7 DON!! turn, so you can\'t rely too much on 6C Law».<br>Bersagli di Oden: «<b>6C Enel</b>, for the same base cost reason as the Elbaf Giants. Also <b>3C Holy</b> if you don\'t have Yasopp to rest and attack Holy, since freezing it is the next best thing.»<br>«Perona Spam» (più copie di Perona 5c, o rigiocata con 6C Law): «stunning 2 characters every turn halts a lot of their offense and lets you reach your 10C Shanks turn safely».<br>Trash Event starve: «useful for taking out early aggro characters against Purple Enel or Elbaf Aggro».'},
    {f:'neb', v:'even', txt:'<b>Go First</b> — Rapidfire MU spread del 1/09: «1st: Slightly Favored / 2nd: Even». Mulligan: <b>Oden, Weenies</b>. Premessa esplicita alla tabella: «the yellow decks &amp; Enel are in the midst of evolving to counter Mihawk so this could be different soon».<br>Elenca inoltre <b>Hand Rip PEnel</b> fra i «MU\'s that I need to test more that are losing».<br>Sul 6Hawk: il suo 7k «is also relevant against P Enel so they can\'t Lightning Dragon you for free without any other invested resources» — ma per Nebulus «NEITHER of these decks are extremely relevant in the meta», quindi non lo gioca.<br>Su ST32 Zoro come tech: «very good on 3/4 Don into decks that rely on weenies such as P Enel… <b>if P Enel becomes a problem I may cut some YCBMS to play this card</b> to lower hand size &amp; deal with their board».<br>Su Oden: «the card that propelled the deck back into relevance so it can actually fight against the overlord named <b>P Enel</b>». Su Decken: contro P Enel è «your first 1k to toss».<br>Card draw, esempio commentato: «the opposing PEnel has a multitude of ways to kill your last weenie and prevent you from double developing. I would usually commit to <b>not playing YCBMS</b> and swinging a Kin\'emon at Shura and then 5 at lead».'},
    {f:'rond', v:'even', txt:'<b>Die roll: First</b>. Game plan: <b>«Full Value / Control by default — but constantly look for opportunities to change gears»</b>. «This is probably one of the least autopilot matchups in the guide.»<br><b>Mulligan</b>: «2+ searchers or 1 searcher + 5c». «Going 1st hand is unplayable if he starts ohm ohm , so i\'d mulligan»; andando secondi i due spell di Mihawk servono a tenere su la vita sugli swing da 7 o a contestare «franky/law/ reiju/ pink, or even out an early ohm».<br><b>Leggi la loro apertura</b>: «Early Holly → Control becomes more attractive. Early Ohm → Aggro becomes more attractive.» Con Ohm → Ohm «we\'re realistically not winning a traditional value war»: accetta che il board morirà e chiediti «how much damage they can generate before they die». Avere già <b>Electrical Luna</b> rende la corsa molto più attraente.<br><b>Late</b>: la linea control stabilisce 1–2 Shanks 10c e poi comprime il danno in un clock di due turni; la linea aggro usa Luna per negare il loro board mentre continui in faccia.<br>«The mistake is not choosing control or aggro. The mistake is continuing to play the same game after the information in front of you tells you that game is losing.» → <a href="guide/rondino.html#05b-enel">capitolo completo</a>'},
    {f:'sam', v:'na', txt:'⚠️ <b>samsansOP non tratta Enel.</b> Verificato riga per riga sul video da 2h, sulle note e sul confronto video↔note: nessuna occorrenza di Enel, né delle carte del mazzo (Ohm, Mamaragan, Holy, Lightning Dragon, Gamma Knife, Shura, Reiju), né della versione hand-rip. L\'unica riga «Enel» che gli viene attribuita è nel documento <i>LawSopp vs HawkRona</i>, ed è un\'estrapolazione dell\'autore di quel documento, non una posizione di Sam: nel sito è già segnalata come tale.<br>Conseguenza pratica: su questo matchup la lista Mihawk+Perona di Sam non ha un piano dichiarato. Se la giochi, le uniche fonti che parlano esplicitamente di Perona contro Enel sono Raphterra («Perona Spam») e Elijah sul Dojo («Perona is excellent against Enel because it is hard to cleanly remove»).'},
  ],
  accordo:[
    '<b>Si va primi</b> — Raphterra e NebulusTCG lo dicono in tabella, Impact in cima alla slide. È uno dei due soli matchup (con Kaido) in cui Mihawk rinuncia al secondo.',
    '<b>Oden si conserva per i grossi Enel.</b> Impact: «Oden is great at stalling out big Enels, save them to try and do so». Raphterra spiega il perché tecnico: Oden guarda il <b>costo base</b>, quindi prende 6C Enel anche dopo che si è alzato di costo. Nebulus lo chiama la carta che ha riportato il mazzo in gioco «against the overlord named P Enel».',
    '<b>Yasopp uccide i 4-costo prima dello snowball.</b> Il pattern di vittoria di Enel è sempre lo stesso: un corpo sticka → giocano un altro 4-costo → rimuovono il tuo. Yasopp spezza la catena. Elijah dice esattamente la stessa cosa dal Dojo.',
    '<b>Le weenie servono per i loro 1-costo</b>, e devono costare poco: «establish searchers to remove their 1 cost units without having to invest much in doing so».',
    '<b>Non aspettarti che il tuo board resti in piedi.</b> Impact: «don\'t really expect your board to stick / not be frozen». Elijah: «do not expect your board to remain untouched». Il piano non è proteggere i corpi, è costringerli a rispondere a più corpi di quanti ne possano rimuovere.',
    '<b>Shanks è la carta che chiude.</b> Shanks toglie la minaccia grossa (spesso Reiju), Luna congela il resto, i searcher puliscono gli 1-costo: Enel resta senza attacchi «unless they have a Shura». E a 0 vita è finita: «they have no +3-4k Event counters».',
    '<b>Hand-rip Law va giocato attorno, non prevenuto.</b> Impact e Elijah concordano sul metodo: counterare presto un attacco minore con le carte che nel matchup non servono (Decken, Kawamatsu) per non restare con la mano critica esposta. «The goal is not to prevent every Law. The goal is to prevent consecutive Law turns.»',
  ],
  conflitti:[
    {t:'Prendere vita presto o tenere il cuscinetto?', pos:[
      {f:'impact', txt:'<b>Tieni il cuscinetto.</b> «Try to counter at least 1 of their swings per turn so that you don\'t lose more than 1 life a turn. You\'ll need a life buffer to resolve back to back Shanks as Enel is one of the decks that can pressure you efficiently.»'},
      {f:'dojo6', txt:'<b>Prendi vita liberamente.</b> Elijah, VOD review 27/08: «Take early life liberally», perché le carte che peschi dalla vita migliorano la mano (Perona, Kin\'emon, stage).'},
      {f:'dojo3', txt:'<b>Regola di mezzo.</b> La domanda da farsi è: «Will there be enough attacks above 6k before my 10-DON!! turn that taking this 6k now is actually dangerous?» Se no, prendere è giusto. Ma «when Enel has a wide one-drop board and repeated 6k attacks, Mihawk must be more careful: the total number of swings can become more dangerous than the individual attack size».'},
    ], nota:'Non è un vero paradosso: Impact ragiona sul <b>numero di vite che servono per risolvere due Shanks di fila</b> (e quindi conta all\'indietro dal letale), Elijah sul <b>valore in carte</b> della vita presa presto. La sintesi operativa è la domanda di Elijah: conta quanti attacchi sopra 6k arriveranno prima del tuo turno da 10 DON!!. Se il loro board è largo di 1-costo, vale la regola di Impact.'},
    {t:'La versione hand-rip', pos:[
      ...
      {f:'impact', txt:'Tratta Enel come un matchup vincente e non distingue la variante hand-rip: dice solo di giocarci attorno counterando presto.'},
      {f:'dojo3', txt:'Elijah la mette fra le ragioni per cui Enel è «harder now than in OP16.5»: «Enel can hand-rip key pieces», insieme a X-Drake e Law.'},
    ], nota:'Chi ha testato la variante (Nebulus, Elijah) è più pessimista di chi la tratta come una nota a margine (Impact). Se all\'evento ti aspetti la lista hand-rip, il verdetto ottimista non si applica direttamente.'},
    {t:'6C Mihawk: tech obbligata o carta che non serve?', pos:[
      {f:'raph', txt:'<b>È la tech del matchup.</b> Il 7k sopravvive a Gum Gum Lightning senza riduzione di potenza, attacca per 7 senza DON!! (difficile da counterare senza bruciare combo pieces), e gioca l\'altro personaggio <b>attivo</b>, quindi niente Lightning Dragon gratis.'},
      {f:'neb', txt:'<b>Riconosce l\'argomento e lo scarta:</b> il 7k «is also relevant against P Enel so they can\'t Lightning Dragon you for free» — «however, NEITHER of these decks are extremely relevant in the meta», quindi gioca 6Law.'},
    ], nota:'È lo stesso identico argomento tecnico con una conclusione opposta, e la differenza è solo il meta atteso. Se vai a un evento con tanti Enel, il ragionamento di Nebulus si ribalta da solo.'},
    {t:'Perona 5c: quanto pesa davvero', pos:[
      {f:'raph', txt:'«Perona Spam»: «against matchups like Purple Enel… stunning 2 characters every turn halts a lot of their offense and lets you reach your 10C Shanks turn safely». La sua On KO la rende appiccicosa contro i mazzi di rimozione.'},
      {f:'dojo3', txt:'Confermato dalla pratica: «in one Enel game, Perona remained in play and attacked several times because Enel could not clear it cleanly… if Perona had been any other 5-cost body, it would have been removed immediately».'},
      {f:'impact17', txt:'Nella Q&amp;A del 17/09 la mette fra le tech valide: «in the aggro build the opponent cannot Yasopp-bomb her; good into rest-spell decks, <b>Enel</b> and Luffy-Ace».'},
      {f:'sam', txt:'⚠️ Nessuna posizione: samsansOP gioca la lista Mihawk + Perona 5c ma non tratta il matchup Enel.'},
    ], nota:'Qui le fonti vanno tutte nella stessa direzione: è uno dei pochi punti in cui teoria (Raphterra), pratica su ladder (Elijah) e lista da torneo (Impact) coincidono senza attriti.'},
  ],
  boxes:[
    {t:'La regola del 5k (la correzione più concreta di tutte)', txt:'Da due sessioni del Dojo, ripetuta come «a major correction»: <b>non attaccare Enel per 5k se hai DON!! inutilizzati e nessun motivo per tenerli aperti.</b> Un attacco da 5k viene Mamaragan\'ato in modo efficiente: «Enel keeps hand parity, Enel gains a life, that life later absorbs a larger 7k attack». Se il DON!! non ti serve per Samurai, Boat, search, counter event o sviluppo, mettilo sull\'attacco. La formulazione secca di Elijah: «<b>Do not give Enel a clean Mamaragan if you could have attacked for a real number instead.</b>»'},
    {t:'Triplo Ohm: Samurai anche i corpi grossi', txt:'Eccezione alla regola normale. Contro un board di Ohm multipli «your medium bodies are often dying no matter what… trying to clear every Ohm can be futile». Elijah normalmente non userebbe mai Samurai su corpi grossi, ma «against a board like triple Ohm, he may Samurai them because they are unlikely to survive either way»: meglio convertirli in carte prima che gli Ohm se li mangino in trade.'},
    {t:'La sequenza letale, passo per passo', txt:'La win condition di Elijah, che coincide con quella di Impact: 1) sopravvivi alla pressione early senza svuotare la mano; 2) riduci il loro board con Perona, Yasopp, Oden e Law; 3) portali abbastanza in basso di vita per Shanks; 4) Shanks + Luna; 5) spegni il board di 1-costo; 6) costringili a spendere risorse senza poter attaccare indietro; 7) secondo Shanks per chiudere. La variante di Impact è la «secret win condition»: se sono a <b>1 vita</b> e hai <b>due Shanks</b>, il primo Shanks manda tutto in vita e il secondo uccide il turno dopo.'},
    {t:'Cosa sa fare Enel che non sapeva fare prima', txt:'La lista di Elijah del 3/09 sul perché il matchup si è indurito rispetto a OP16.5: «Enel is more specifically built to beat Mihawk», ha «X-Drake, Law, and other interactions», «can hand-rip key pieces», «can open many one-drops, especially <b>Ohm</b>», «can use <b>Mamaragan</b> to gain life and preserve hand», «can force Mihawk to protect board while still keeping a wide engine». Conclusione: «this is no longer a matchup Mihawk can treat as routine».'},
    {t:'Come lo costruiscono loro (utile per leggerli)', txt:'Dalla Q&amp;A di Impact del 17/09, dal lato Enel: lots of 1s, Laws, Frankys, Pinks, <b>4 Enel</b>; 2 Divine Departure per i brick; split <b>2-2 Gamma Knife / Gum-Gum Lightning</b> (non 3-1) così Pink può cercare l\'uno o l\'altro. Sequenza di rimozione: corpo riposato → Gamma Knife, corpi attivi → Gum-Gum Lightning. E <b>niente cane</b>: «a pretty stuff card if everyone\'s playing the rest spell — the dog just dies». Se vedi il cane, il loro list building è vecchio di una settimana.'},
  ],
  carte:['OP15-058','OP14-038','ST32-002','OP17-031','OP14-033','OP17-022','ST24-004','OP06-033'],
},
{
