...
},
{
  ...
  verdetti:[
    ...
    {f:'rond', v:'na', txt:'⚠️ <b>La guida Metafy di Rondino non ha un capitolo Enel.</b> Nella «matchups bible» Enel non compare; nel capitolo 4 è citato solo come termine di paragone sul tipo di skill richiesta: «while something like enel almost always plays the same exact game and you tend to want to express your skill via optimizing every little sequencing troughout your turns. Mihawk does almost exactly the opposite» (refusi verbatim dalla fonte).<br>Rondino tratta Enel <b>solo nella masterclass del 16/09</b> — vedi il riquadro «Aggiornamento settembre» qui sopra — e nella masterclass annuncia che la sua guida avrà «an Enel chapter with more videos to come»: alla data di questo hub non è ancora uscito.'},
