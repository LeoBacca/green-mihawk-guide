...
> **Utrecht didn't convince me that Mihawk was overrated. It convinced me that being the undisputed deck to beat comes with a cost.**

Now that the target is starting to move elsewhere, I think **Mihawk** is in an even healthier position going forward.

[Decklist image: screenshot delle statistiche OPTCGSim — pannello "Select your leader" con il proprio leader OP14 MIHAWK e la riga "Opponent Leaders". Ricostruito qui sotto come tabella.]

**Il proprio leader (pannello di sinistra)**

[Card: Dracule Mihawk (OP14 MIHAWK) — 5000, verde]
...
> ⚠️ Nota: nello screenshot il nome del leader nella tabella "Select your leader" è tagliato/troncato ("?P14 Mihaw"). Inoltre W/R 78.1% su N# 32 non coincide con il 72% su 25 partite (18-7) del pannello di sinistra: entrambi i valori sono riportati così come appaiono nella fonte.

**[Table: Opponent Leaders]**
...
> ⚠️ Nota: l'etichetta "ST30 &" è troncata nello screenshot (la carta raffigurata è "Luffy & Ace"). La barra di scorrimento indica che la lista degli Opponent Leaders prosegue oltre l'ultima colonna visibile.

**Ultimately, i think mihawk is insanely well positioned to face ANYTHING in the format, and except some random times where we may brick, the deck is super solid in a big tournament because you can essentially always play into anything and with any dice.**
...
> ⚠️ Nota: refusi presenti nella fonte, trascritti verbatim — "i think mihawk" (minuscole), "i'm", "im", "most of this games" (per "these games"), "30ish".
