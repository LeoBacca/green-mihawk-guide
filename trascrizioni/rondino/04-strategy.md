# Rondino — 4. General deck strategy

> Fonte: Metafy — guida Green Mihawk OP17. Trascrizione verbatim EN.
...
***<u>Your job is not only to find the best play every turn, but to understand what kind of game you need to create</u>***
...
**"Given the position I'm currently in, what line gives me the highest possible chance of still winning this game?"**
...
*"What's normally good in the mirror?"*

I was thinking:

*"Which cards help me win THIS game?"*
...
***<u>Don't just ask yourself what the best play is. Ask yourself what game you're trying to play—and whether that game actually leads to you winning.</u>***
...
***<u>Once you've identified your win condition, every decision should be evaluated by one question: does this move me closer to that win condition?</u>***
...
> ⚠️ Nota: refusi presenti nella fonte, trascritti verbatim — "i wont", "ill talk", "early/mid/ and late game" (barra spuria), "mihawk" in minuscolo.
...
> ⚠️ Nota: refusi presenti nella fonte, trascritti verbatim — "troughout" (per "throughout"), "consctructing" (per "constructing"), "lets" (per "let's"), "enel" e "mihawk" in minuscolo. Il secondo paragrafo della Conclusion è una frase incompleta nella fonte (inizia con "While..." e non ha proposizione principale).
...
> ⚠️ Nota: il capitolo 4 è interamente testuale — nessuna immagine di carta, banner, decklist, diagramma di board, tabella o video embed. Nessun ID carta è quindi leggibile; le carte sono citate solo per nome/costo.
